...
TEMP_URL = f"mysql+mysqlconnector://{DB_USERNAME}:{DB_PASSWORD}@3.37.186.94:3306/"
DATABASE_URL = f"mysql+mysqlconnector://{DB_USERNAME}:{DB_PASSWORD}@3.37.186.94:3306/capstone"
